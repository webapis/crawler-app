...
debugger
    if(start){
        ...
        const links = await page.evaluate(()=>Array.from( document.querySelectorAll('a')).map(m=>{return {href:m.href,title:m.innerText}}).filter(f=>f.href.includes('https://www.adidas.com.tr/')) ) 
            debugger
