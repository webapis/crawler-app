...
debugger
const kategoriler =['okul','bebek','clutch','kova','Postacı','baskılı','el çanta','plaj','tote','gece','baget','alışveriş','bez','kot','abiye','portföy','gece','kol','telefon','çapraz','bel','sırt','omuz','spor','outdoor']
