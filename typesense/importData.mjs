...
debugger
const anaKategoriler =[{title:'telefonluk',keywords:['telefonluk',"telefon"]},{title:'çanta',keywords:["omuz",'sırt','çanta',"çantası",'çantasi','saplı','baget','bag','çantaasi','backpack']},{title:"cüzdan",keywords:["cüzdan",'cuzdan','cüzdanı','cüzdanı','cüzdani']},{title:"valiz",keywords:["valiz",'bavul']},{title:"kartlık",keywords:["kartlık",'kartlik','kartvizitlik']},{title:"anahtarlık",keywords:["anahtarlık"]},{title:"clutch",keywords:["clutch"]},{title:"portföy",keywords:["portföy",'portföyü']},{title:"kılıf",keywords:["kılıf",'kılıfı']},{title:"alışveriş",keywords:["alışveriş"]}]
