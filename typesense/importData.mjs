...
debugger
const anaKategoriler =[{title:'çanta',keywords:['çanta',"çantası",'çantasi','portföy','saplı','baget','portföyü']},{title:"cüzdan",keywords:["cüzdan",'cuzdan','cüzdanı']},{title:"valiz",keywords:["valiz"]},{title:"kartlık",keywords:["kartlık",'kartlik']},{title:"anahtarlık",keywords:["anahtarlık"]},{title:"clutch",keywords:["clutch"]}]
