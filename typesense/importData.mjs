...
debugger
const anaKategoriler =[{title:'telefonluk ',keywords:['telefonluk',"telefon"]},{title:'çanta',keywords:['çanta',"çantası",'çantasi','portföy','saplı','baget','bag']},{title:"cüzdan",keywords:["cüzdan",'cuzdan','cüzdanı','cüzdani']},{title:"valiz",keywords:["valiz"]},{title:"kartlık",keywords:["kartlık",'kartlik','kartvizitlik']},{title:"anahtarlık",keywords:["anahtarlık"]},{title:"clutch",keywords:["clutch"]},{title:"portföy",keywords:["portföy",'portföyü']}]
